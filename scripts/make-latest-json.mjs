 ...
 *   bun run make:latest --repo owner/name       # 指定 GitHub 仓库（默认 Alvinzero/HangCore-Agent）
...
const DEFAULT_REPO = 'Alvinzero/HangCore-Agent';
...
const notes = flag('notes') || notesFromFile || readChangelogNotes(version) || `HangCore Agent v${version}`;
