...
<p>
  ...
  <a href="https://github.com/Alvinzero/HangCore-Agent/stargazers"><img alt="Stars" src="https://img.shields.io/github/stars/Alvinzero/HangCore-Agent?style=flat-square&color=FF6F91"></a>
</p>
...
<p>
  ...
  <a href="https://github.com/Alvinzero/HangCore-Agent/releases">📦 Releases</a>&nbsp;·&nbsp;
...
> 📦 **Installers**: use [GitHub Releases](https://github.com/Alvinzero/HangCore-Agent/releases) first. Mainland China users can use the [Baidu Netdisk mirror](https://pan.baidu.com/s/5GPonoJNrwJ7GciBSDgXLaA) (shared as `nomifun`). You can also install from source or run the server with Docker.
...
```bash
git clone https://github.com/Alvinzero/HangCore-Agent.git
cd nomifun-tauri
bun install
...
- Browse [open issues](https://github.com/Alvinzero/HangCore-Agent/issues) for a place to start.
...
| 🐙 **GitHub** | [Alvinzero/HangCore-Agent](https://github.com/Alvinzero/HangCore-Agent) · [Issues](https://github.com/Alvinzero/HangCore-Agent/issues) · [Releases](https://github.com/Alvinzero/HangCore-Agent/releases) |
