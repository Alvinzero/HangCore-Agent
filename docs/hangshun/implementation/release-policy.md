...
- `v0.1.2`: `kun-acp-adapter` MVP，完成最小 ACP stdio handshake、一次 prompt 输入和流式文本输出。
- `v0.1.3`: Kun approval / cancel / user input 事件映射。
- `v0.1.4`: CodingTask + SpecArtifact 最小结构化保存。
