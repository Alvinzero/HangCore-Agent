...
------------------------------------------------------------------------
-- Coding Tasks & Spec Artifacts
------------------------------------------------------------------------

-- v0.1.10 traceability spine for conversation-bound coding work. The
-- selected_agent_id/backend fields record the chosen local Agent/Profile
-- while the existing ACP/Kun runtime loop remains authoritative for execution.
