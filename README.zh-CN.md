...
<p>
  ...
  <a href="#-快速开始">🚀 快速开始</a>&nbsp;·&nbsp;
  <a href="https://github.com/Alvinzero/HangCore-Agent/releases">📦 下载</a>&nbsp;·&nbsp;
...
> 📦 **下载安装包**：优先使用 [GitHub Releases](https://github.com/Alvinzero/HangCore-Agent/releases)；中国大陆下载可使用 [百度网盘镜像](https://pan.baidu.com/s/5GPonoJNrwJ7GciBSDgXLaA)（分享名：`nomifun`）。也可以从源码安装，或用 Docker 跑服务器。
...
- 从 [open issues](https://github.com/Alvinzero/HangCore-Agent/issues) 找一个起点。
